...
pie(Cases, main = "Standark pie chart ")
...
Benth.le <- tapply(Benthic$Richness,
                   ...
                   FUN=length)
#se= standard error=
#standard deviation/square roor of the sample size
